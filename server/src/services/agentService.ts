 ...
 *
 * The evaluator keeps using the same running server instance,
 * so the initialized agent and its feed remain available.
 */
const agentStore =
 ...
 *
 * This gives the evaluator enough time to observe
 * genuinely new posts over the 48-hour evaluation window.
 */
...
export class AgentService {
    ...
    public initializeAgent(
         ...
         *
         * This runs asynchronously so the initialization
         * endpoint can immediately return the agentId.
         */
